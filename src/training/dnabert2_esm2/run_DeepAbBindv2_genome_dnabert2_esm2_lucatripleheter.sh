...
python run.py \
  ...
  --vector_dirpath ../../vectors/$DATASET_NAME/dnabert/dnabert2/117M/#../../vectors/$DATASET_NAME/esm/esm2/3B \
  --matrix_dirpath ../../matrices/$DATASET_NAME/dnabert/dnabert2/117M/#../../matrices/$DATASET_NAME/esm/esm2/3B \
  --seq_fc_size null \
