...
embedding_input_size_c=2560
matrix_max_length=3827
# none, avg, max, value_attention
MATRIX_POOLING_TYPE="value_attention"

# for llm
llm_type="nucleotide_transformer-esm"
llm_version="multi-species-esm2"
llm_step="2.5B-3B"
...
python run.py \
  ...
  --embedding_input_size_c $embedding_input_size_c \
  ...
  --vector_dirpath ../../vectors/$DATASET_NAME/nucleotide_transformer/multi-species/2.5B/#../../vectors/$DATASET_NAME/esm/esm2/3B \
  --matrix_dirpath ../../matrices/$DATASET_NAME/nucleotide_transformer/multi-species/2.5B/#../../matrices/$DATASET_NAME/esm/esm2/3B \
  --seq_fc_size null \
