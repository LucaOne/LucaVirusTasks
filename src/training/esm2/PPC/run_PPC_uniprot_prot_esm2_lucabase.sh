...
python run.py \
  ...
  --vector_dirpath ../../vectors/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$llm_type/$llm_version/$llm_step \
  --matrix_dirpath ../../matrices/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$llm_type/$llm_version/$llm_step \
  --seq_fc_size null \
