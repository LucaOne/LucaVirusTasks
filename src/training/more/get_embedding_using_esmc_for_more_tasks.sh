...
python predict_embedding.py \
    ...
    --save_path ../../../../matrices/HIV_Entry_Latent_Fold_00/esm/esmc/600M \
...
python predict_embedding.py \
    ...
    --save_path ../../../../matrices/HIV_Entry_Observed_Fold_00/esm/esmc/600M \
    --embedding_type matrix \
    --matrix_add_special_token \
    --embedding_complete \
    --embedding_complete_seg_overlap \
...
python predict_embedding.py \
    ...
    --save_path ../../../../matrices/HIV_immune_escape_10_1074_Fold_00/esm/esmc/600M \
    --embedding_type matrix \
    --matrix_add_special_token \
    --embedding_complete \
    --embedding_complete_seg_overlap \
...
# HIV_immune_escape_esmcNC117_Fold_00
cd ./src/llm/esmc
export CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7"
python predict_embedding.py \
    --llm_type esmc \
    ...
    --save_path ../../../../matrices/HIV_immune_escape_3BNC117_Fold_00/esm/esmc/600M \
    --embedding_type matrix \
    --matrix_add_special_token \
    --embedding_complete \
    --embedding_complete_seg_overlap \
...
python predict_embedding.py \
    ...
    --save_path ../../../../matrices/HIV_immune_escape_sera_mean_Fold_00/esm/esmc/600M \
    --embedding_type matrix \
    --matrix_add_special_token \
    --embedding_complete \
    --embedding_complete_seg_overlap \
...
python predict_embedding.py \
   ...
   --llm_version 600M \
    ...
    --save_path ../../../../matrices/HK19_immune_escape_per_serum/esm/esmc/600M \
    --embedding_type matrix \
    --matrix_add_special_token \
    --embedding_complete \
    --embedding_complete_seg_overlap \
...
python predict_embedding.py \
  ...
  --save_path ../../../../matrices/PE09_immune_escape_per_serum/esm/esmc/600M \
  --embedding_type matrix \
  --matrix_add_special_token \
  --embedding_complete \
  --embedding_complete_seg_overlap \
...
python predict_embedding.py \
  ...
  --save_path ../../../../matrices/Phage_PVP/esm/esmc/600M \
  --embedding_type matrix \
  --matrix_add_special_token \
  --embedding_complete \
  --embedding_complete_seg_overlap \
