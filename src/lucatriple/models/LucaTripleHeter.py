...
@file: LucaTripleHeter
@desc: LucaTripleHeter for heterogeneous three sequences
'''
...
class LucaTripleHeter(BertPreTrainedModel):
    def __init__(self, config, args):
        super(LucaTripleHeter, self).__init__(config)
