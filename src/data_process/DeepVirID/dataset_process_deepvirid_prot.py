...
for dataset_type in ["train", "dev", "test"]:
    if not os.path.exists("../../../dataset/DeepVirID/protein/binary_class/%s" % dataset_type):
        os.makedirs("../../../dataset/DeepVirID/protein/binary_class/%s" % dataset_type)
csv_writer(
    dataset=train_set,
    handle="../../../dataset/DeepVirID/protein/binary_class/train/train.csv",
    header=["seq_id", "seq_type", "seq", "label"]
)

csv_writer(
    dataset=dev_set,
    handle="../../../dataset/DeepVirID/protein/binary_class/dev/dev.csv",
    header=["seq_id", "seq_type", "seq", "label"]
)

csv_writer(
    dataset=test_set,
    handle="../../../dataset/DeepVirID/protein/binary_class/test/test.csv",
    header=["seq_id", "seq_type", "seq", "label"]
)

csv_writer(
    dataset=[[0], [1]],
    handle="../../../dataset/DeepVirID/protein/binary_class/label.txt",
    header=["label"]
)

write_fasta("../../../dataset/DeepVirID/protein/binary_class/DeepVirID_all_prot.fasta", fasta)


if not os.path.exists("../../../dataset/DeepVirID/protein/binary_class/fasta_split"):
    os.makedirs("../../../dataset/DeepVirID/protein/binary_class/fasta_split")
...
for idx in range(split_num):
    ...
    write_fasta(
        "../../../dataset/DeepVirID/protein/binary_class/fasta_split/DeepVirID_all_prot_part_%02d_of_%02d.fasta" % (idx + 1, split_num),
        cur_fasta
    )
...
if len(independent_test_fasta) > 0:
    ...
    if not os.path.exists("../../../dataset/DeepVirID/protein/binary_class/independent_test"):
        os.makedirs("../../../dataset/DeepVirID/protein/binary_class/independent_test")
    csv_writer(
        dataset=test_set,
        handle="../../../dataset/DeepVirID/protein/binary_class/independent_test/independent_test.csv",
        header=["seq_id", "seq_type", "seq", "label"]
    )
    write_fasta("../../../dataset/DeepVirID/protein/binary_class/independent_test_prot.fasta", independent_test_fasta)
