...
for label in [0, 1]:
    ...
    if deleted_train_negative_num > 0:
        ...
        csv_writer(
            ...
            handle="../../../dataset/DeepVirID_4_gpu/gene/binary_class/deleted_train_set_records.csv",
...
for dataset_type in ["train", "dev", "test"]:
    if not os.path.exists("../../../dataset/DeepVirID_4_gpu/gene/binary_class/%s" % dataset_type):
        os.makedirs("../../../dataset/DeepVirID_4_gpu/gene/binary_class/%s" % dataset_type)
csv_writer(
    dataset=train_set,
    handle="../../../dataset/DeepVirID_4_gpu/gene/binary_class/train/train.csv",
    header=["seq_id", "seq_type", "seq", "label"]
)

csv_writer(
    dataset=dev_set,
    handle="../../../dataset/DeepVirID_4_gpu/gene/binary_class/dev/dev.csv",
    header=["seq_id", "seq_type", "seq", "label"]
)

csv_writer(
    dataset=test_set,
    handle="../../../dataset/DeepVirID_4_gpu/gene/binary_class/test/test.csv",
    header=["seq_id", "seq_type", "seq", "label"]
)

csv_writer(
    dataset=[[0], [1]],
    handle="../../../dataset/DeepVirID_4_gpu/gene/binary_class/label.txt",
    header=["label"]
)

write_fasta("../../../dataset/DeepVirID_4_gpu/gene/binary_class/DeepVirID_4_gpu_all_nucl.fasta", fasta)
...
if len(independent_test_fasta) > 0:
    ...
    if not os.path.exists("../../../dataset/DeepVirID_4_gpu/gene/binary_class/independent_test"):
        os.makedirs("../../../dataset/DeepVirID_4_gpu/gene/binary_class/independent_test")
    csv_writer(
        dataset=test_set,
        handle="../../../dataset/DeepVirID_4_gpu/gene/binary_class/independent_test/independent_test.csv",
        header=["seq_id", "seq_type", "seq", "label"]
    )
    write_fasta("../../../dataset/DeepVirID_4_gpu/gene/binary_class/independent_test_nucl.fasta", independent_test_fasta)
